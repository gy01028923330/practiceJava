...
import com.example.app.board.dto.BoardCreateDto;
...
public class BoardController {
    ...
    public ResponseEntity<String> createBoard(@RequestBody BoardCreateDto createDto) {
        boardService.create(createDto.getBoardName(), createDto.getCategory());
    ...
    public ResponseEntity<String> updateBoard(@PathVariable Long id, @RequestBody BoardUpdateDto updateDto) {
